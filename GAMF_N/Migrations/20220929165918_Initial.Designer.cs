...
namespace GAMF_N.Migrations
{
    ...
    [Migration("20220929165918_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GAMF_N.Models.Course", b =>
                {
            ...
            modelBuilder.Entity("GAMF_N.Models.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("GAMF_N.Models.Student", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GAMF_N.Models.Enrollment", b =>
                {
                    b.HasOne("GAMF_N.Models.Course", "Course")
                        .WithMany("Enrollments")
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GAMF_N.Models.Student", "Students")
                        .WithMany("Enrollments")
